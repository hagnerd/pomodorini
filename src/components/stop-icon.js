...
export default function StopIcon({ size = 50 } = {}) {
  return (
    <svg
      version="1.1"
      id="emoji"
    ...
    >
      <g id="_x23F9__xFE0F__1_">
        <g>
          <path
            fill="#DD7676"
            d="M49.3,18c2.6,0,4.7,2.1,4.7,4.7v26.5c0,2.6-2.1,4.7-4.7,4.7H22.7c-2.6,0-4.7-2.1-4.7-4.7V22.7
