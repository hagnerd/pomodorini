...
export default function SettingsIcon({ size = 50 } = {}) {
  return (
    <svg
      version="1.1"
      id="emoji"
    ...
    >
      <g id="_x2699__xFE0F_">
        <g>
          <path
            fill="#D0CFCE"
            d="M51.3,29.8c0,0-1.8-0.5-1.1-2.1l4.5-7.5L51,16.8l-0.7-0.7l-7.1,4.7c-0.9,0.4-2-0.1-2.3-1.1L39,11.9h-5h-1
        ...
        <path
          fill="#9B9B9A"
          d="M36,24.9c-5.5,0-10,4.5-10,10s4.5,10,10,10s10-4.5,10-10S41.5,24.9,36,24.9z M36,39.9c-2.8,0-5-2.2-5-5
